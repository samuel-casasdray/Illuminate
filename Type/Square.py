...
def squareStarter(app: guizero.App, n, old, x, y, i, timer, replaceGrille, nbFunc):
...
def square(app: guizero.App, n, old, x, y, replaceGrille, nbFunc, wait=0):
    app.after(int(wait * 1000), app.repeat, [1, squareStarter, [app, n, old, x, y, 0, None, replaceGrille, nbFunc]])
